...
options.add_experimental_option('prefs', {
        ...
        "download.default_directory" : r"/Users/alejandramontoya/Documents/Dissertation/2008-2011",
        "savefile.default_directory": r"/Users/alejandramontoya/Documents/Dissertation/2008-2011"})
...
for year in range(2008,2012):
        ...
        for dpto in range(len(departamentos)):
                ...
                driver.switch_to.parent_frame()
                driver.switch_to.frame(0)
                driver.find_element_by_xpath('/html/body/form/div[4]/div[3]/div[2]/table/tbody/tr[6]/td[1]/img').click()